...
replace (
	...
	// github.com/evmos/ethermint => github.com/kava-labs/ethermint v0.14.0-kava-v20.1
	github.com/evmos/ethermint => github.com/oraichain/ethermint-cosmos-0.50 v0.0.0-20240809101848-bf7d8240cc09
